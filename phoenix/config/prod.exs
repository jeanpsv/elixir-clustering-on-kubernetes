...
# ElixirClusteringOnKubernetesWeb.Endpoint.init/2 when load_from_system_env is
...
# start per endpoint:
#
#     config :elixir_clustering_on_kubernetes, ElixirClusteringOnKubernetesWeb.Endpoint, server: true
#
